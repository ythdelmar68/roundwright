...
| PHI-2 | A harness `main` ref could be mistaken for this qualification run's content pin. | Record `681c7e9359a3767892a615ffa032d42b51e7be15` historically as non-qualifying; record canonical main separately and require future explicit owner selection of a new exact reviewed pin. | Resolved in canonical document. |
