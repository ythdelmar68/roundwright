...
def qualify_supervisor_sequence(adapters: tuple[CodexSupervisorAdapter, ...], requests: tuple[CodexSupervisorRequest, ...], readiness: SupervisorShadowReadiness, binding: SupervisorSequenceBinding, resolved_policy: ResolvedSupervisorSequencePolicy, lifecycle: ExternalSupervisorLifecycle, recorder: ExternalSupervisorRecorder, *, evidence_time: int, freshness_until: int, runtime_store: ExternalSupervisorRuntimeStore, trusted_policy_receipt: TrustedReviewPolicyReceipt, review_authority_store: FileReviewAuthorityStore, review_authority_evidence: ReviewAuthorityEvidenceReceipt, checkpoint_session: Callable[[str], None], checkpoint_turn: Callable[[str, str], None], review_authority_expectation: ReviewAuthorityExpectation | None = None) -> SupervisorSequenceQualificationResult:
    ...
    try:
        ...
        if not _digest(trusted_source) or not _digest(trusted_authority) or not _digest(trusted_authority_receipt) or not _digest(runtime_authority) or not _digest(authority_evidence_digest) or not _digest(authority_anchor):
        ...
        if (expectation.source_identity, expectation.authority_identity, expectation.runtime_store_source_identity, expectation.authority_receipt_digest, expectation.candidate_sha, expectation.configuration_anchor_digest, expectation.trusted_review_floor, expectation.ready_at, expectation.freshness_until) != (trusted_source, trusted_authority, runtime_authority, trusted_authority_receipt, binding.candidate_sha, authority_anchor, resolved_policy.configuration.trusted_review_floor, readiness.ready_at, freshness_until):
        ...
        if authority_evidence is review_authority_evidence or (authority_evidence.receipt_digest, authority_evidence.source_identity, authority_evidence.authority_identity, authority_evidence.runtime_store_source_identity, authority_evidence.authority_receipt_digest, authority_evidence.candidate_sha, authority_evidence.configuration_anchor_digest, authority_evidence.trusted_review_floor) != (authority_evidence_digest, trusted_source, trusted_authority, runtime_authority, trusted_authority_receipt, binding.candidate_sha, authority_anchor, resolved_policy.configuration.trusted_review_floor):
