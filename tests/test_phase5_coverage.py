...
class Phase5CoverageTests(unittest.TestCase):
    ...
    def test_issue_132_semantic_inventory_is_independently_pinned_and_ordered(self) -> None:
        ...
        self.assertEqual(
            tuple(coverage.ISSUE_132_E1R19_FINDING_REQUIREMENTS),
        ...
        self.assertEqual(
            tuple(coverage.ISSUE_132_E1R22_FINDING_REQUIREMENTS),
    ...
    def test_issue_132_finding_mapping_rejects_omitted_code_or_test(self) -> None:
        ...
        with patch.object(coverage, "ISSUE_132_E1R18_FINDING_REQUIREMENTS", e1r18), self.assertRaisesRegex(coverage.CoverageError, "E1R18 finding mapping"):
            coverage._validate_issue_132_semantic_tests()
        e1r19 = dict(coverage.ISSUE_132_E1R19_FINDING_REQUIREMENTS)
        e1r19.pop("E1R19-05")
        with patch.object(coverage, "ISSUE_132_E1R19_FINDING_REQUIREMENTS", e1r19), self.assertRaisesRegex(coverage.CoverageError, "E1R19 finding mapping"):
            coverage._validate_issue_132_semantic_tests()
        ...
        with patch.object(coverage, "ISSUE_132_E1R21_FINDING_REQUIREMENTS", e1r21), self.assertRaisesRegex(coverage.CoverageError, "E1R21 finding mapping"):
            coverage._validate_issue_132_semantic_tests()
        e1r22 = dict(coverage.ISSUE_132_E1R22_FINDING_REQUIREMENTS)
        e1r22.pop("E1R22-05")
        with patch.object(coverage, "ISSUE_132_E1R22_FINDING_REQUIREMENTS", e1r22), self.assertRaisesRegex(coverage.CoverageError, "E1R22 finding mapping"):
            coverage._validate_issue_132_semantic_tests()
